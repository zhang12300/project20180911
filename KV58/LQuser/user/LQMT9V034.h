...
#define IMAGEW  80  //列 WIDTH  待采集摄像头图像宽度列数
//
//#define LCDH    30  //OLED显示的行数
//#define LCDW    75  //OLED显示的列数

#define SCL_Out     DDRB19=1 //DDRE1=1      //配置输出作为SCL_Out
#define SDA_Out     DDRB18=1 //DDRE0=1      //配置作为输出作为SDA_Out
#define SDA_In      DDRB18=0 //DDRE0=0      //配置作为输入作为SDA_In

#define SCL_High    PTB19_OUT=1   //PTE1_OUT=1   //配置输出高电平
#define SCL_Low     PTB19_OUT=0   //PTE1_OUT=0   //配置输出低电平
#define SDA_High    PTB18_OUT=1   //PTE0_OUT=1   //配置输出高电平
#define SDA_Low     PTB18_OUT=0   //PTE0_OUT=0   //配置输出低电平
#define SDA_Data    PTB18_IN      //PTE0_IN      //读取引脚上的引脚状态
...
//uint8 SCCB_RegWrite(uint8 Device,uint8 Address,uint16 Data);
