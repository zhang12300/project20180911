...
{
   ServoFTM_PWM_Init(FTM3,FTM_CH2,10000,sever_middle);//Mot11-PTC11    舵机方向左边大右边小
...
{      
  ...
  { 
    FTM_CnV_REG(FTM3, FTM_CH2) = duty;  //舵机，用PTC11
...
{
  char txt[16];
  uint16_t servopwm=sever_middle;   
#ifdef __USE_TFT18
