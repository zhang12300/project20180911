...
//定义当前所用舵机的参数
//#define     Servo_Left        1670 //左转极限，每个舵机数值不同
//#define     Servo_Middle      1420 //中心位置，每个舵机数值不同
//#define     Servo_Right       1170 //右转极限，每个舵机数值不同
...
#define FTM2_QDPHA  PTA10//PTB18       //PTA10、PTB18 PTE22 PTA1
#define FTM2_QDPHB  PTA11//PTB19       //PTA11、PTB19 PTE23 PTA2
