...
{ 
  ...
  GPIO_Init(GPIOC,17,GPO,1);
  GPIO_Init(GPIOC,18,GPO,1);
  GPIO_Init(GPIOC,19,GPO,1);
  time_delay_ms(5);
...
//
//             
//        if(Loc[0][119-x*2]!=-LIM)
//       {
//         imgdrawbuff[x*80+Loc[0][119-x*2]/2+40]=0;
//         
//        }
//        if(Loc[1][119-x*2]!=LIM)
//       {
//         imgdrawbuff[x*80+Loc[1][119-x*2]/2+40]=0;
//         
//        }
//        if(Loc[2][119-x*2]!=LIM)
//       {
//         imgdrawbuff[x*80+Loc[2][119-x*2]/2+40]=0;
//         
//        }
//
//  }
//  for(i=0;i<80;i++)
//  {
//    imgdrawbuff[(119-control_line)/2*80+i]=0;
//  }
//       
//  
//  for(y=0;y<8;y++)
...
void  OLED_Draw_camera()
{
  ...
  for(x=0;x<59;x++)
  {
        ...
        if(LMR[0][119-x*2]!=-LIM)
       {
         imgdrawbuff[x*80+LMR[0][119-x*2]/2+40]=0;
         
        }
        if(LMR[1][119-x*2]!=LIM)
       {
         imgdrawbuff[x*80+LMR[1][119-x*2]/2+40]=0;
         
        }
        if(LMR[2][119-x*2]!=LIM)
       {
         imgdrawbuff[x*80+LMR[2][119-x*2]/2+40]=0;
        }
  }
//  for(i=0;i<80;i++)
//  {
